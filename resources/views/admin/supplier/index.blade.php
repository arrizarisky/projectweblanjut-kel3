    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-base-200 p-6 rounded shadow-md">
                <div class="mb-4">
                    <a href=" {{ route('admin.supplier.create') }} " class="btn btn-primary"> <i data-feather="plus"></i> Tambah Supplier</a>
                </div>
                        ...
                        <tbody>
                            @forelse($suppliers as $index => $supplier)
                                <tr>
                                    ...
                                    <td class="space-x-2">
                                        <a href="{{ route('admin.supplier.edit', $supplier) }}" class="btn btn-sm btn-warning"><i data-feather="edit"></i></a>
                                        <form action="{{ route('admin.supplier.destroy', $supplier) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
