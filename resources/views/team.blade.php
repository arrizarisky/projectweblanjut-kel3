...
@section('content')
    ...
    <div class="flex flex-col items-center justify-center px-4 py-8  mx-auto max-w-screen-xl lg:px-6">
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Introducing our <span class="text-blue-600 dark:text-blue-500">amazing</span> Team.</h1>
        <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400"> in designing and implementing an inventory management system.</p>
    </div>
